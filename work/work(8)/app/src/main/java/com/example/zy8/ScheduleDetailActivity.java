...
public class ScheduleDetailActivity extends AppCompatActivity implements OnClickListener, OnTimeSetListener {
    ...
    private com.example.zy8.database.ScheduleArrangeHelper mScheduleHelper; // 声明一个日程安排的数据库帮助器
    ...
    protected void onResume() {
        ...
        // 获得数据库帮助器的实例
        mScheduleHelper = new com.example.zy8.database.ScheduleArrangeHelper(this, DbHelper.db_name, null, 1);
        // 查询数据库获得当天的日程安排信息
